...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "homes" }),
...
--Create Tabs
    ...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleAutoFarmLevel", {Title = "🌾 Auto Farmar Level", Default = false })
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "👾 Auto Perto do Mob", Default = false })
...
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "🌾 Auto Farmar Bone", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "🌾 Auto Farmar Cake Prince", Default = false })
...
spawn(function()
  ...
  --v.Humanoid:ChangeState(14)
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "🌾 Auto Farmar Material", Default = false })
...
if Third_Sea then
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "🏹 Auto Caçador de Elite", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "🌫️ Auto Miragem Island", Default = false })
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "⚔️ Auto Tushita", Default = false })
...
Tabs.Race:AddParagraph({
    Title = "Misc Race",
    Content = "🌾 Auto Farmar Acient Quest"
})
